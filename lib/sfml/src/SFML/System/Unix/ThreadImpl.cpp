...
#endif
//thread aux
//extern "C" void _stdcall (*registerThread)(sf::Thread* thread) = NULL;
//extern "C" void _stdcall (*unregisterThread)(sf::Thread* thread) = NULL;

/*
extern "C" void _stdcall setThread(
  void (*registerThread_p)(sf::Thread*),
  void (*unregisterThread_p)(sf::Thread*) ) {
    registerThread = registerThread_p;
    unregisterThread = unregisterThread_p;
}
*/
